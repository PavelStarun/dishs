...
INSERT INTO dishs(restaurant_id, category_id, name, descr, price) VALUES 
(1, 3, 'Сет для Большой Компании', 'Сет для Большой Компании - это выгодный сет на большую компанию, который состоит из пары бургеров Биг Хит, 
Картофеля на выбор, Стрипсов (7 шт.) и двух напитков на выбор.', 999);
...
INSERT INTO dishs(restaurant_id, category_id, name, descr, price) VALUES 
(2, 4, 'Острый Картофель Деревенский стандартный', 'Золотистая картошечка по-деревенски — с Острой штукой, нашей новой приправой с огоньком. 
